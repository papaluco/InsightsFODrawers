...
const PerformanceDrawer: React.FC<Props> = ({ isOpen, onClose }) => (
    ...
    <div className="px-8 py-5 bg-white border-b border-gray-200 flex items-center justify-between shrink-0 shadow-sm">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Page loads, API requests, drawer opens, and rendering times</p>
        </div>
      </div>
      <button
        onClick={onClose}
