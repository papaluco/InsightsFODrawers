...
export const SchoolieIcon: React.FC<IconProps> = ({ className = "h-5 w-5", size = 24 }) => (
  <svg 
...
export const DistributeIcon: React.FC<IconProps> = ({ className = "", size = 20 }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
...
export const SparklesIcon: React.FC<IconProps> = ({ className = "", size = 20 }) => (
  ...
  >
    ...
    <path d="M18 3l.8 2L21 6l-2.2.8L18 9l-.8-2L15 6l2.2-.8L18 3z" />
    
    {/* Small sparkle bottom left */}
    <path d="M6 15l.8 2L9 18l-2.2.8L6 21l-.8-2L3 18l2.2-.8L6 15z" />
  </svg>
);

export const ClipboardIcon = ({ className = "h-4 w-4", size = 16 }: { className?: string; size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const SearchIcon = ({ className = "h-4 w-4", size = 16 }: { className?: string; size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const CopyIcon = ({ className = "h-4 w-4", size = 16 }: { className?: string; size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ImageIcon = ({ className = "h-4 w-4", size = 16 }: { className?: string; size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const DataIcon = ({ className = "h-4 w-4", size = 16 }: { className?: string; size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const DatabaseIcon = ({ className = "h-4 w-4", size = 16 }: { className?: string; size?: number }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
