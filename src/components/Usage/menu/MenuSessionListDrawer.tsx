...
interface Props {
  ...
  onEventsClick?: (session: MenuSessionRow) => void;
  onUserClick?: (session: MenuSessionRow) => void;
  onDistrictClick?: (session: MenuSessionRow) => void;
  isChildDrawerOpen?: boolean;
}

const MenuSessionListDrawer: React.FC<Props> = ({
  sessions,
  title,
  isOpen,
  onClose,
      ...
      <div className="px-8 bg-white border-b border-gray-200 flex items-center justify-between shrink-0 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Menu Analysis sessions</p>
          </div>
        </div>
...
export default MenuSessionListDrawer;
